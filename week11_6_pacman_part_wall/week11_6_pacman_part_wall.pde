//week11_6_pacman_part_wall
//修改自weeek11_5_pacman_part4_many_beans_for_for_array
//小精靈 張嘴(在動)
void setup(){
  size(600,600); //改視窗大小,30的倍數
}
...
void draw(){
  ...
  if((x-15)%30==0 && (y-15)%30==0){
    ...
    if(next==0) { dx = +1; dy = 0;dir = 0;} //dir:2向左PI
    if(next==3) { dx = 0; dy = -1;dir = 3;} //dor:3向上PI*1.5
